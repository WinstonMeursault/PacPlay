/**
 * @file pacplay_server_sdk.c
 * @brief Server SDK thin wrapper — delegates to the shared implementation
 *        in pacplay_sdk.c.
 *
 * @date 2026-06-17
...
PacPlaySDK *pacplay_srv_create(void) { return sdk_create(); }

void pacplay_srv_destroy(PacPlaySDK *sdk) { sdk_destroy(sdk); }
...
void pacplay_srv_poll(PacPlaySDK *sdk) { sdk_poll(sdk); }
