/**
 * @file auth.h
 * @brief Client-side authentication module header.
 *
 * Authentication functions are declared in @c client.h.  This header
 * exists as the module boundary for @c auth.c and includes the parent
